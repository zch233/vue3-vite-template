...
export default ({mode, command}: ConfigEnv):UserConfig => {
  const {VITE_APP_TITLE, VITE_PORT, VITE_PUBLIC_PATH, VITE_BUILD_COMPRESS, VITE_BUILD_COMPRESS_DELETE_ORIGIN_FILE, VITE_LEGACY, VITE_USE_IMAGEMIN, VITE_DROP_CONSOLE, VITE_DROP_DEBUG} = wrapperEnv(loadEnv(mode, process.cwd()))
